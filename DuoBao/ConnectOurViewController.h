...
@property (weak, nonatomic) IBOutlet UILabel *zaixianqq;
@property (weak, nonatomic) IBOutlet UILabel *guanfang1qun;
@property (weak, nonatomic) IBOutlet UILabel *guanfang2qun;
