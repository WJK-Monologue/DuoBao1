...
- (void)clickQuitButtonAction:(id)sender
{
    ...
    [self performSelector:@selector(changin:) withObject:nil afterDelay:0];
}

-(void)changin:(NSNotification *)changer
{
    
    [[NSNotificationCenter defaultCenter]postNotificationName:@"shuaxinhongdian" object:nil];
}
