...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    _yjButton =[[UIButton alloc]initWithFrame:CGRectMake(0, 0, FullScreen.size.width/3, 35)];
    ...
    _yjLine = [[UILabel alloc]initWithFrame:CGRectMake(0, 34, FullScreen.size.width/3, 2)];
    ...
    _ejButton =[[UIButton alloc]initWithFrame:CGRectMake(FullScreen.size.width/3, 0, FullScreen.size.width/3, 35)];
    ...
    _ejLine = [[UILabel alloc]initWithFrame:CGRectMake(FullScreen.size.width/3, 34, FullScreen.size.width/3, 2)];
    ...
    _sjButton =[[UIButton alloc]initWithFrame:CGRectMake(FullScreen.size.width/3*2, 0, FullScreen.size.width/3, 35)];
    ...
    _sjLine = [[UILabel alloc]initWithFrame:CGRectMake(FullScreen.size.width/3*2, 34, FullScreen.size.width/3, 2)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        if (cell == nil)
        {
            ...
            cell.numLabelWidth.constant = (FullScreen.size.width-32)/3;
        }
        //设点点击选择的颜色(无)
        ...
        if (serverSourceArray.count > 0) {
            ...
            cell.warn1Label.text = [NSString stringWithFormat:@"购宝提成%.2f％/分享文章提成%.2f％",[str4 doubleValue]*100.0,[str1 doubleValue]*100.0];
            cell.warn2Label.text = [NSString stringWithFormat:@"购宝提成%.2f％/分享文章提成%.2f％",[str5 doubleValue]*100.0,[str2 doubleValue]*100.0];
            cell.warn3Label.text = [NSString stringWithFormat:@"购宝提成%.2f％/分享文章提成%.2f％",[str6 doubleValue]*100.0,[str3 doubleValue]*100.0];
        }
